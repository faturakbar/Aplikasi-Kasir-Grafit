...
if (isset($_POST['update'])) {
    ...
    mysqli_query($koneksi, "UPDATE kategori_barang SET kategori_barang='$kategori_barang' WHERE kode_kategori='$kode_kategori'");
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <form action="" method="post">
                    <div class="row">
                        <?php
                        $kategori_barang = mysqli_query($koneksi," SELECT * FROM  kategori_barang WHERE kode_kategori='$kode_kategori'");
